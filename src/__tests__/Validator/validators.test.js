...
describe('Validators api', () => {
  test('instance and signature functions', () => {
  ...
  describe('chain functions', () => {
    test('isRequired.isMinLength.isEqual', () => {
  ...
  describe('static functions', () => {
    ...
    test('validateOne without errors', () => {
  ...
  describe('custom messages', () => {
    test('all rules with custom messages', () => {
      const values = {
        phoneNumber: '',
        email: '',
      };
  ...
  describe('static functions with custom function', () => {
